   ...
   const logos = [
    ...
    return (
        <div className=' m-auto mt-20 grid gap-5  grid-cols-1 lg:grid-cols-5 justify-items-center md:grid-cols-3  mb-20   '>
           ...
           <img src={logo.img} alt="" className='transition ease-in-out delay-100 bg-white-500 hover:-translate-y-1 hover:scale-110 hover:text-[#e0f2fe] duration-300 ... animate-fade-up animate-once' />
           </>  )
           } 
        </div>
    );
